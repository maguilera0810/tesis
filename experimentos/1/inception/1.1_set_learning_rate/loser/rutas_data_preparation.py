...
class Directorios():
    ...
    def __init__(self, cwd=".."):
        ...
        #--------------------EXPERIMENTOS-------------------------------------
        self.experimentos = os.path.join(cwd, "experimentos")

        self.exp_final = os.path.join(self.experimentos, "final")
        self.exp_final_resnet_batchs = os.path.join(self.exp_final, "resnet","batchs_data")
        self.exp_final_inception_batchs = os.path.join(self.exp_final, "inception","batchs_data")
        self.exp_final_frankensnet_batchs = os.path.join(self.exp_final, "frankensnet","batchs_data")
