...
class BatchData(Callback):
    ...
    def on_train_begin(self, logs=None):
        ...
        os.mkdir(os.path.join(self.filepath_batch,
                 f"{self.model_name}_"+self.dia))
        # self.list_epochs = []
    ...
    def on_epoch_begin(self, epoch, logs=None):
        logs = logs or {}
        self.list_batchs = []
        self.file_batch = open(
            f"{self.filepath_batch}/{self.model_name}_{self.dia}/epoch_{epoch}.txt", "w")
